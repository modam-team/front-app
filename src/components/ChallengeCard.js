...
export default function ChallengeCard({ title = '책을 다 읽어보기 챌린지', progress = 0.7, count = 4 }) {
...
const styles = StyleSheet.create({
  card: { marginHorizontal: 16, marginTop: 12, padding: 12, borderRadius: 12, borderWidth: 1, borderColor: '#e5e7eb', flexDirection: 'row', gap: 12 },
  thumb: { width: 60, height: 40, backgroundColor: '#f3f4f6', borderRadius: 6 },
  title: { fontWeight: '700', marginBottom: 8, color: '#111827' },
  barBg: { height: 6, backgroundColor: '#f3f4f6', borderRadius: 999, overflow: 'hidden' },
